...
params = {"learning_rate": 0.41, "n_estimators": 9, "max_depth": 1}

clf = ensemble.GradientBoostingRegressor(**params)

clf.fit(X_train_scl, y_train)
mse = mean_squared_error(y_test, clf.predict(X_test_scl))
print("MSE: %.4f" % mse)
